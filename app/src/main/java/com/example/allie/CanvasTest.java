...
public class CanvasTest extends View {
    ...
    public CanvasTest(Context context) {
        ...
        outerPaint.setStyle(Paint.Style.FILL); // fills entire background
        ...
        Point p4 = new Point((int) pxFromDp(context, 80) + (screenWidth / 4), (int) pxFromDp(context, 40));
...
//        mPath.lineTo(p4.x, p4.y);
        mPath.close();
        // actual drawing of mPath is in onDraw method
